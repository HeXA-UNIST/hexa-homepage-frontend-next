...
export default class ProjectRepository {
    public static async getProjects(): Promise<ProjectsQueryResult> {
        const response = await fetch(
            `${WebConstants.API_URL}/project/list`
        );
        return new ProjectsQueryResult(await response.json());
    }
    public static async queryProjects({
        ...
        return new ProjectsQueryResult(await (await fetch(`${WebConstants.API_URL}/project/list?searchText=${searchText}`)).json())
    ...
    public static async getProjectById(id: number): Promise<Project> {
        ...
        try {
            ...
            return new Project(await response.json());
        } catch (error) {
            console.log(error);
            throw error;
        }
