            ...
            >
                <div className="flex flex-col h-[50rem] flex-wrap justify-evenly content-evenly items-start font-bold ml-10">
                    <ActivityItem
                        ...
                        color="bg-purple-800"
                    >
                        <Image className="w-20 group-hover/item:scale-125 transition-all" src="/images/icon/hexaLogoPurple.png" width={80} height={80} alt="" />
                    </ActivityItem>
                    <ActivityItem
                        title="프로젝트"
                        ...
                        color="bg-white"
                        >
                        <Image className="w-20 bg-black group-hover/item:scale-125 transition-all" src="/images/icon/hexaLogoBackground.png" width={80} height={80} alt="" />
                    </ActivityItem>
                    <ActivityItem
                        title="세미나"
                        ...
                        color="bg-blue-900"
                        >
                        <Image className="w-20 group-hover/item:scale-125 transition-all" src="/images/icon/hexaLogo.png" width={80} height={80} alt="" />
                    </ActivityItem>
                    <ActivityItem
                        title="부트캠프"
                        ...
                        color="bg-black"
                        >
                        <Image className="w-20 group-hover/item:scale-125 transition-all" src="/images/icon/hexaLogoGold.png" width={80} height={80} alt="" />
                    </ActivityItem>
                </div>
            </ContentFrame>
        </div>
